...
export const TimelineFlipped = ({ data }: { data: TimelineEntry[] }) => {
    ...
    <div className="w-full font-sans md:px-0" ref={containerRef}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="relative pl-4 pr-20 md:pr-4 w-full">
            ...
            <div className="sticky flex flex-col md:flex-row z-10 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pr-20 md:text-3xl font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
          </div>
